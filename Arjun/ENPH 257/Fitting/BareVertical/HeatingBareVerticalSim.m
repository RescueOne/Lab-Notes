%Constants for fit
kc = 10.7; %Convection coefficient of horizontal Al rod (W/(m^2K))
k = 145; %Constant of conductivity of Al (W/(mK))
e = 0.21; %Emmisivity of sandblasted Al rod
Cp = 975; %Specific heat capacity of Al (J/(K kg))
loss = .25; %Fractional loss of power to environment

%Power
V = 15.1; %V, voltage into power resistor
I = 0.890; %A, current into power resistor
Ppower = V*I; %W
